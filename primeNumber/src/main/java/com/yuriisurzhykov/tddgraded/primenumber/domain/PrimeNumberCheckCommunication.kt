...
interface PrimeNumberCheckCommunication :
    Communication.LiveData.Observe<PrimeNumberCheckResult>,
    Communication.LiveData.Put<PrimeNumberCheckResult>,
    Communication.LiveData.Post<PrimeNumberCheckResult> {

    abstract class Abstract : Communication.LiveData.Abstract<PrimeNumberCheckResult>(),
