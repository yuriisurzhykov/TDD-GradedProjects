...
package com.yuriisurzhykov.tddgraded.stringreverse.base
...
import com.yuriisurzhykov.tddgraded.stringreverse.ScreenOrientationChangeAction
...
abstract class AbstractTest {
    ...
    @get:Rule(order = 2)
    var activityRule = ActivityScenarioRule(StringReverseActivity::class.java)

    protected lateinit var activity: StringReverseActivity
    ...
    protected fun getString(id: Int) = InstrumentationRegistry.getInstrumentation().context.getString(id)
